...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <div class=" d-flex justify-content-between w-100 px-5">
            <div class="h5 text-light" href="#">Our App</div>
            <div id="datetime" class="text-light h5"></div>
            <div class="text-light h5">{{ auth()->user()->name }}</div>
    ...
    <main class="d-flex flex-nowrap">
        <div class="flex-shrink-0 p-3 h-100" style="width: 280px;">
            <a href="/"
                ...
                <span class="fs-5 fw-semibold">Kelompok 2</span>
            </a>
            <ul class="list-unstyled ps-0">
                ...
                <li class="mb-1">
                    ...
                    <div class="collapse show" id="home-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            <li><a href="/products"
                                    class="link-body-emphasis d-inline-flex text-decoration-none rounded">- Table</a>
                            </li>
                            <li><a href="/products/create"
                                    class="link-body-emphasis d-inline-flex text-decoration-none rounded">- Create</a>
                            </li>
                            <li><a href="#"
                        ...
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            ...
                            <li>
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button type="submit"
                                        class="btn-link link-dark d-inline-flex text-decoration-none rounded">-
                                        Logout</button>
                                </form>
                            </li>
                        </ul>
...
<script>
    function displayDateTime() {
        ...
        var date = addLeadingZero(currentDate.getDate());
        ...
        var formattedDateTime = day + ' ' + date + ' ' + month + ' ' + year + ' ' + hours + ':' + minutes + ':' +
            seconds;

        // Menampilkan tanggal dan jam dalam elemen dengan id "datetime"
        document.getElementById('datetime').innerHTML = formattedDateTime;

        // Memperbarui tanggal dan jam setiap detik (1000 ms)
        setTimeout(displayDateTime, 1000);
    }

    // Fungsi untuk menambahkan angka 0 di depan jika hanya terdiri dari satu digit
